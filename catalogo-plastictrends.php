...
<section class="Catalogo">
	<div class="contenedor">
		...
		<?php
			...
			$result = $link->query('SELECT COUNT(*) as total_products FROM catalogo_productos ORDER BY id');
			    ...
			    if($result->num_rows > 0) {
			        ...
			        while ($row = $result->fetch_assoc()) {
						...
						<li>
							...
							<a href="<?php echo _ROOT.'productos/'.$row['codigo']?><?php if($rowColorLink['codigo'] != '') { echo '&codigo='.$rowColorLink['codigo']; } else { }; ?>">
